...
/// - AppBar: back arrow, title “Update Student Status”.
///
/// - Student header card: Name “Saleh”, Grade, Student ID, Route and Stop.
/// - Current status row with status pill “On Bus”, Last Updated time, Parent
/// Contact phone.
/// - Status options as large selectable cards with icons:
///   - On Bus (selected)
///   - Dropped Off
///   - Picked Up
/// - Add a small “Status Update Rules” info card at bottom (short bullet
/// points).
class UpdateStudentStatusWidget extends StatefulWidget {
  const UpdateStudentStatusWidget({super.key});

  static String routeName = 'UpdateStudentStatus';
  static String routePath = '/updateStudentStatus';

  @override
  State<UpdateStudentStatusWidget> createState() =>
      _UpdateStudentStatusWidgetState();
}

class _UpdateStudentStatusWidgetState extends State<UpdateStudentStatusWidget> {
  late UpdateStudentStatusModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateStudentStatusModel());
  }
