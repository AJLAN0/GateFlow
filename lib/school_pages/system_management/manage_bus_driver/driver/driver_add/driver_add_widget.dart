...
class DriverAddWidget extends StatefulWidget {
  const DriverAddWidget({super.key});

  static String routeName = 'DriverAdd';
  static String routePath = '/driverAdd';

  @override
  State<DriverAddWidget> createState() => _DriverAddWidgetState();
}

class _DriverAddWidgetState extends State<DriverAddWidget> {
  late DriverAddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DriverAddModel());
