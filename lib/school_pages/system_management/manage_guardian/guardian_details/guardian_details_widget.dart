...
class GuardianDetailsWidget extends StatefulWidget {
  const GuardianDetailsWidget({super.key});

  static String routeName = 'GuardianDetails';
  static String routePath = '/guardianDetails';

  @override
  State<GuardianDetailsWidget> createState() => _GuardianDetailsWidgetState();
}

class _GuardianDetailsWidgetState extends State<GuardianDetailsWidget> {
  late GuardianDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GuardianDetailsModel());
  }
